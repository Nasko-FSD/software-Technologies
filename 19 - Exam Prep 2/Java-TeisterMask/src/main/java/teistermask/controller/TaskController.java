...
public class TaskController {
	...
	public String index(Model model) {
		...
		//List<Task> openTasksSecondWay = this.taskRepository.findAllByStatus("Open");
		//List<Task> inProgressSecondWay = this.taskRepository.findAllByStatus("In Progress");
		//List<Task> finishedSecondWay = this.taskRepository.findAllByStatus("Finished");
